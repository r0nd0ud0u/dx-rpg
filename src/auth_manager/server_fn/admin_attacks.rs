...
pub async fn admin_get_attack_form(
    ...
    Ok(AttackFormData {
        ...
        degats: v["Dégâts"].as_i64().unwrap_or(0),
        soin: v["Soin"].as_i64().unwrap_or(0),
        regen_mana: v["Regen mana"].as_i64().unwrap_or(0),
        regen_rage: v["Regen rage"].as_i64().unwrap_or(0),
        regen_vigueur: v["Regen vigueur"].as_i64().unwrap_or(0),
...
pub async fn admin_save_attack_form(
    ...
    let attack = serde_json::json!({
        ...
        "Dégâts": form.degats,
        "Soin": form.soin,
        "Regen mana": form.regen_mana,
        "Regen rage": form.regen_rage,
        "Regen vigueur": form.regen_vigueur,
        "Photo": form.photo,
        "Effet": effet,
    });
